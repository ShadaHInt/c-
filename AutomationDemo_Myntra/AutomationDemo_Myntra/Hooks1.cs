...
namespace Automation_DemoMyntra
{
    public class Hooks : BaseClass
    {
        ...
        public static void InitializeReport()
        {
            ...
            htmlReporter.Config.ReportName = "  Myntra Online shopping Application";




            extent.AddSystemInfo("<font style='color:blue'>" + "Tested Site", "<font style='color:orange'>Myntra web automation</font>");
        ...
        public static void AfterScenario()
        {
            ...
            //string path = "D:\\MyntraAccessbilityReport.html";
