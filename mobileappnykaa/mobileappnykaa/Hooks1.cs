...
namespace Medicineproject
{
    ...
    public sealed class Hooks1 : BaseClass
    {
        ...
        public static void InitializeReport()
        {
            ...
            htmlReporter.Config.ReportName = "Drink Water Reminder";




            extent.AddSystemInfo("<font style='color:blue'>" + "Tested Site", "<font style='color:orange'>Myntra </font>");
